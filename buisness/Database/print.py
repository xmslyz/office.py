def wydruk_ogolny():
    ...
    # print('2.  records_in_qdate__list -> ', ssc.records_in_qdate__list())
    ...
    # print('7.  binations__list -> ', ssc.binations__list())
    # print('8.  sum_of_binations -> ', ssc.sum_of_binations())
    # print('9.  gregorian__list -> ', ssc.gregorian__list())
    ...
    # print('14. aplicated_stipends__list -> ', ssc.aplicated_stipends__list())
    # print('15. amount_of_aplicated -> ', ssc.amount_of_aplicated())
    # print('16. not_paid_but_aplicated__list -> ', ssc.not_paid_but_aplicated__list())
    # print('17. not_paid_but_aplicated__list -> ', ssc.not_paid_but_aplicated__list())
    # print('18. not_paid_nor_aplicated__list -> ', ssc.not_paid_nor_aplicated__list())
    # print("\n")
...
def wydruk_osoba():
    ...
    # qdata = f"{qdate}-__"
    # res = mysca.select_all_where_q_like(qcelebrated_by="%_", qcelebration_date=qdata)
    # mylist = []
    # for _ in res:
    #     mylist.append(_[3])
    # kto = list(set(mylist))
