...
class TestAmount(TestCase):
    def test_amount__below0(self):
        ...
        with self.assertRaises(Exception) as context:
            stip.amount = "-23.12"
        self.assertTrue(
            "Kwota nie może być mniejsza od zera" in str(context.exception)
        )
    ...
    def test_amount__string(self):
        ...
        with self.assertRaises(Exception) as context:
            stip.amount = "qaz"
        self.assertTrue(
            "Wprowadzana wartość nie jest liczbą" in str(context.exception)
        )
...
class TestCelebratingAbrev(TestCase):
    def test_celebrating_pr__morethan3(self):
        ...
        self.assertTrue(
            "Przekroczono dopuszczalną ilość znaków (3)."
...
class TestCelebrationHour(TestCase):
    def test_not_an_hour(self):
        ...
        self.assertTrue(
            "Podaj właściwy format godziny" in str(context.exception)
        )
