...
class TestComputing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        emp1 = (
            ...
            "AA",
            "Wikary",
            "{'dziesięcina': '230.00', 'dke': '100', 'szkoła': '100'}",
            1,
        )
        emp2 = (
            "bb2",
            ...
            "BB",
            "Wikary",
            "{'dziesięcina': '230.00', 'dke': '100', 'szkoła': '120'}",
            1,
        )
        emp3 = (
            "cc3",
            ...
            "CC",
            "Wikary",
            "{'dziesięcina': '230.00', 'dke': '100', 'szkoła': '140'}",
            1,
        )
        emp4 = (
            "dd4",
            ...
            "DD",
            "Wikary",
            "{'dziesięcina': '230.00', 'dke': '100', 'szpital': '80'}",
            1,
        )
        emp5 = (
            "ee5",
            ...
            "EE",
            "Wikary",
            "{'dziesięcina': '230.00', 'dke': '100', 'areszt': " "'200'}",
            0,
        )
        emp6 = (
            "ff6",
        ...
        self.emp.create_connection(
            2, msg, [emp1, emp2, emp3, emp4, emp5, emp6]
        )

        msg = """INSERT INTO intentions VALUES (NULL,?,?,?,?,?,?,?,?,?) """
        self.int.create_connection(
            2,
            msg,
            [
                int1,
...
#         with self.assertRaises(Exception) as context:
#             stmt.record_by_id("0")
#         self.assertTrue("No record with this id" in str(context.exception))
#
#     #  LISTS
